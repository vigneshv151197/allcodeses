...
public class Fd {
	  ...
	  {
		  System.setProperty("webdriver.chrome.driver","C:\\Users\\t262\\Documents\\chromedriver_win32(1)\\chromedriver.exe");
...
//		  driver.findElement(By.id("eClick")).clear();
		  WebElement temp = driver.findElement(By.xpath("//img[@src='/bundle/assets/images/two-wheeler-img/icons8-edit-24.svg']"));
		  temp.click();
		  Thread.sleep(2000);
...
//		  Smile button
		  driver.findElement(By.xpath("/html/body/section/div/div/div/div/div/div[2]/div[4]/section/div[4]/div[1]/button[10]")).click();
