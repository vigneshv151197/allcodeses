...
//			    Clicking on the Apply button
			driver.findElement(By.xpath("(//a[@aria-label='Apply-small-business-loan'])[1]")).click();

//				Keying Applicant's Name
			driver.findElement(By.id("qkAFName")).sendKeys("Perumal");

//				Keying Mobile Number
			driver.findElement(By.id("qkAFMobile")).sendKeys("7575891919");
...
//			Checkbox
			driver.findElement(By.xpath("/html/body/div[6]/div/div[3]/div/div/div[2]/form/div[8]/div[1]/div/label/span")).click();
			Thread.sleep(3000);
...
//				OTP Verification
			...
			Thread.sleep(3000);
//				OTP Verify button
			driver.findElement(By.xpath("/html/body/div[10]/div/div/div/div/div[2]/div/div[3]/button")).click();
			Thread.sleep(3000);
