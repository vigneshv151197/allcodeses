...
public class tw1 {
	...
	public void beforeMethod() {
		...
		driver.get("https://uat.shriramcity.com");
	...
	public void TwoWheeler() throws InterruptedException {
		...
		driver.findElement(By.id("TWMobile")).sendKeys("9192347995");
		Thread.sleep(2000);
...
//		 		  driver.findElement(By.id("TWEmpType")).clear();
		...
		s8.selectByVisibleText("PERAK DUEL ABS BS6");
		Thread.sleep(2000);
...
//		driver.findElement(By.id("TWModeL")).clear();
		...
		s81.selectByVisibleText("ACTIVA 125 STD DRUM BS6");
		Thread.sleep(2000);
		...
		// Smile
		Thread.sleep(3000);
		driver.findElement(By.xpath("/html/body/section/div/div/div/div/div/div[2]/div[4]/section/div[4]/div[1]/button[8]"))
				.click();
